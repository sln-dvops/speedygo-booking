...
export function BulkSendToManual({
  ...
  const handleAddressChange = (index: number, data: BaseAddressFormData) => {
    ...
    // Create updated recipients array
    ...
    // Also update the formData with the latest recipients
    updateFormData({
      ...formData,
  ...
  const handleNext = () => {
    // Ensure all recipient data is saved before proceeding
    updateFormData({
      ...formData,
        ...
        <div className="space-y-6">
          <div className="bg-yellow-100 p-4 rounded-lg mb-4">
            ...
            <p className="text-sm text-gray-600">
              Please enter the delivery details for each parcel. Use the tabs below to navigate between parcels.
            </p>
          </div>
